    ...
    :m_pMyServer(server)
{
    ...
    pChannel = new cFPZInChannel("Frequency input 0..1MHz", 0, channelSettings.at(0) );
    m_ChannelList.append(pChannel);
    pChannel = new cFPZInChannel("Frequency output 0..1MHz", 1, channelSettings.at(1) );
    m_ChannelList.append(pChannel);
    pChannel = new cFPZInChannel("Frequency output 0..1MHz", 2,  channelSettings.at(2) );
    m_ChannelList.append(pChannel);
    pChannel = new cFPZInChannel("Frequency output 0..1MHz", 3, channelSettings.at(3) );
    m_ChannelList.append(pChannel);
