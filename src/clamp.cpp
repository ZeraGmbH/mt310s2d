...
cClamp::cClamp(cMT310S2dServer *server, QString channelName, quint8 ctrlChannel, I2cMuxer::Ptr i2cMuxer, quint8 ctrlChannelSecondary) :
...
void cClamp::initClamp(quint8 type)
{
    ...
    case EMOB200DC:
    {
        ...
        m_RangeListSecondary.append(new cSenseRange(m_pSCPIInterface, "C1000V", "C1000V", true, 1000.0, 4332959.0, 4332959.0 * 1.25, 8388607.0, 1 /*8V*/, commonMask | SenseSystem::Clamp, clampJustData));
